...
with open(path.join(here, 'README.md'), encoding='utf-8') as fhandler:
...
setup(
    ...
    url='https://github.com/Asher256/python-cmdwrapper',
    ...
    keywords='cmdwrapper command cmd wrapper run process',
